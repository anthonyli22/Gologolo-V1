...
export default class AppsterController {
  ...
  registerEventHandler(id, eventName, callback) {
    ...
    if (control) control.addEventListener(eventName, callback);
  }
  ...
  registerAppsterEventHandlers() {
    ...
    this.registerEventHandler(
      ...
      AppsterHTML.CLICK,
      this[AppsterCallback.APPSTER_PROCESS_CREATE_NEW_WORK]
    );
    ...
    this.registerEventHandler(
      ...
      AppsterHTML.CLICK,
      this[AppsterCallback.APPSTER_PROCESS_GO_HOME]
    );
    this.registerEventHandler(
      AppsterGUIId.APPSTER_EDIT_TRASH,
      AppsterHTML.CLICK,
      this[AppsterCallback.APPSTER_PROCESS_DELETE_WORK]
    );
