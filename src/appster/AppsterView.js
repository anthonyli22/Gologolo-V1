...
export default class AppsterView {
  ...
  loadAppText(textName, textValue) {
    if (textName && textValue) this.appText[textName] = textValue;
    else this.appText[textName] = "?";
  ...
  getAppText(textName) {
    if (this.appText[textName]) return this.appText[textName];
    else return "?";
  }
  ...
  buildAppsterHomeScreenDiv() {
    ...
    let homeScreenDiv = this.buildElement(
      AppsterHTML.DIV,
      AppsterGUIId.APPSTER_HOME_SCREEN
    );
  ...
  buildAppsterRecentWorkDiv() {
    let recentWorkHeading = this.buildElement(
      AppsterHTML.H3,
    ...
    let recentWorkList = this.buildElement(
      AppsterHTML.DIV,
      AppsterGUIId.APPSTER_HOME_RECENT_WORK_LIST
    );
    let recentWorkDiv = this.buildElement(
      AppsterHTML.DIV,
  ...
  buildAppsterNewWorkDiv() {
    let newWorkDiv = this.buildElement(
      AppsterHTML.DIV,
      AppsterGUIId.APPSTER_HOME_NEW_WORK_CONTAINER
    );
    let newWorkButton = this.buildElement(
      AppsterHTML.BUTTON,
  ...
  buildAppsterEditScreenDiv() {
    let toolbarDiv = this.buildElement(
      AppsterHTML.DIV,
      AppsterGUIId.APPSTER_EDIT_TOOLBAR
    );
    let headerDiv = this.buildElement(
      AppsterHTML.DIV,
    ...
    let trash = this.buildElement(
      AppsterHTML.DIV,
      AppsterGUIId.APPSTER_EDIT_TRASH
    );
    trash.innerHTML = AppsterSymbols.DELETE;
    toolbarDiv.appendChild(headerDiv);
    toolbarDiv.appendChild(trash);
    let editScreenDiv = this.buildElement(
      AppsterHTML.DIV,
      AppsterGUIId.APPSTER_EDIT_SCREEN
    );
    editScreenDiv.appendChild(toolbarDiv);

    // THIS IS APP-SPECIFIC AND WILL BE DONE BY THE CHILD CLASS
    let workspace = this.buildElement(
      AppsterHTML.DIV,
      AppsterGUIId.APPSTER_EDIT_WORKSPACE
    );
  ...
  buildAppsterYesNoModal() {
    let yesNoModal = this.buildElement(
      AppsterHTML.DIV,
  ...
  buildAppsterConfirmModal() {
    let confirmModal = this.buildElement(
      AppsterHTML.DIV,
    ...
    let confirmFrame = this.buildElement(
      AppsterHTML.DIV,
  ...
  buildAppsterTextInputModal() {
    let textModal = this.buildElement(
      AppsterHTML.DIV,
    ...
    let textFrame = this.buildElement(
      AppsterHTML.DIV,
  ...
  buildWorkListElement(workName) {
    ...
    newA.setAttribute(
      AppsterHTML.CLASS,
      AppsterGUIClass.APPSTER_HOME_WORK_LINK
    );
  ...
  refreshRecentWork(recentWork) {
    ...
    let recentWorkList = document.getElementById(
      AppsterGUIId.APPSTER_HOME_RECENT_WORK_LIST
    );
  ...
  showElement(element, show) {
    if (!element) console.log("WHAT?");
    element.hidden = !show;
    if (show) console.log(element);
